    ...
    <header class="bg-dark py-2">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Tambah Transaksi</h1>
        ...
        <div class="main-1">
            <form name="form" class="container" method="POST" action="proses-transaksi.php">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="id_transaksi" id="formGroupExampleInput" placeholder="Silahkan isi ID Transaksi">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">ID Pelanggan</label>
                    <input type="text" class="form-control" name="id_pelanggan" id="formGroupExampleInput2" placeholder="Silahkan isi ID Pelanggan">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Tanggal</label>
                    <input type="date" class="form-control" name="tanggal" id="formGroupExampleInput2" placeholder="Silahkan isi Tanggal Transaksi">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Jumlah</label>
                    <input type="text" class="form-control" name="jumlah" id="formGroupExampleInput2" placeholder="Silahkan isi Jumlah Barang">
                </div>
                <div class="col-auto">
                    <button type="submit" name="simpan" class="btn btn-primary">Tambah Transaksi</button>
                </div>
            </form>
        </div>
